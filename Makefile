...
up:
	...
	@docker-compose exec -T php /var/www/calendar/bin/console doctrine:migrations:migrate --allow-no-migration --all-or-nothing  -n
	@docker-compose exec -T php /var/www/calendar/bin/console doctrine:migrations:migrate --allow-no-migration --all-or-nothing  -n --env=test
...
install:
	...
	@echo "\033[32mApply migrations...\033[0m"
	@docker-compose exec -T php /var/www/calendar/bin/console doctrine:migrations:migrate --allow-no-migration --all-or-nothing  -n
	@docker-compose exec -T php /var/www/calendar/bin/console doctrine:fixtures:load
	@docker-compose exec -T php /var/www/calendar/bin/console doctrine:migrations:migrate --allow-no-migration --all-or-nothing  -n --env=test
...
db:
	...
	@docker-compose exec -T php /var/www/calendar/bin/console doctrine:fixtures:load  --no-interaction
